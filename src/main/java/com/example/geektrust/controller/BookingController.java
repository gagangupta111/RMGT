...
public class BookingController {
    ...
    public static String bookNormalSlots(Structure structure, String vehicle_id, String vehicle_type, String entry_time){
        ...
        VehicleBookingRequest vehicleBookingRequest = new VehicleBookingRequest(vehicle_id, vehicle_type, entry_time, Constants.EMPTY, null, timeSlot, true);
    ...
    public static String bookAdditionalSlots(Structure structure, String vehicle_id, String exit_time){
        ...
        String vehicle_type = structure.getVehicles_id_type_map().get(vehicle_id);
        TimeSlot previousBookingSlot = structure.getVehicles_slot_map().get(vehicle_id);
        ...
        VehicleBookingRequest vehicleBookingRequest = new VehicleBookingRequest(vehicle_id, vehicle_type, Constants.EMPTY, exit_time, previousBookingSlot, requestedTimeSlot, true);
